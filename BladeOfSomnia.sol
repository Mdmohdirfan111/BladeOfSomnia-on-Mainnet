...
/**
 * @title Blade of Somnia
 * @dev This contract manages the WokeUp token and the game's on-chain logic.
 * The contract owner (the game developer) can mint tokens for players.
 * Players can say GM on-chain and claim tokens based on their game score.
 */
contract BladeOfSomnia is ERC20, Ownable {
     ...
     */
    constructor(address initialOwner) ERC20("WokeUp", "WOKE") Ownable(initialOwner) {}
    ...
    /**
     * @dev Allows a player to claim WokeUp tokens based on their game score.
     * Tokens are minted on a 1:1 ratio with the score (1 score = 1 WOKE token).
